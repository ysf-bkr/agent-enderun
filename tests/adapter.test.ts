...
describe("CLI Adapters", () => {
    ...
    describe("remapFrameworkContent", () => {
        ...
        it("should map folder names and paths dynamically", () => {
            const content = "Source is .enderun/agents/ and .enderun/knowledge/";
    ...
    describe("buildMcpServerEntry", () => {
        it("should build correct entry object", () => {
            ...
            expect(entry.args[0]).toContain("framework-mcp/dist/index.js");
            expect(entry.env.ENDERUN_PROJECT_ROOT).toBe("/path/to/project");
        });
    });
